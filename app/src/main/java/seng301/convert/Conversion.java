...
public class Conversion extends ActionBarActivity
    ...
    public static String bgColor = "#eeeeee";
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch(position){
            case 0:
                objFragment=new Convert();
                break;
            case 1:
                objFragment=new SpecialFormulas();
                break;
            case 2:
                objFragment=new CheatSheet();
                break;
            case 3:
                objFragment=new Options();
                break;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((Conversion) activity).onSectionAttached(
